          ...
          {filtered.map((fav) => {
            ...
            return (
              <div
                ...
                className="group relative bg-zinc-950/80 border border-zinc-800/80 hover:border-rose-500/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded-xl p-3 flex items-center justify-between hover:bg-zinc-900/80 transition-all cursor-pointer shadow-md"
              >
